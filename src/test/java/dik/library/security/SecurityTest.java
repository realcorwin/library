...
public class SecurityTest {
    ...
    @Test
    public void testLoginWithWrongRequestParamsNames() throws Exception {
        when(userService.loadUserByUsername("")).thenThrow(new UsernameNotFoundException(""));
        mvc.perform(formLogin("/login/process").userParameter("wrong").passwordParam("libraryPassword").user("user").password("password")
    ...
    public void testLogin() throws Exception {
        ...
        mvc.perform(formLogin("/login/process").userParameter("libraryUsername").passwordParam("libraryPassword").user("user").password("password")
